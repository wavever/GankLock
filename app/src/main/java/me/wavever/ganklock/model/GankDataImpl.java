...
public class GankDataImpl implements IGankModel{
    ...
    @Override public void getGankData(String today) {
     ...
     * @return true/false
     */
    @Override public boolean isGetToday() {
        return false;
    }
     ...
     * @param ganks 干货数据
     */
    @Override public void saveToDB(final String date,final List<Gank> ganks) {
     ...
     * @return 查询到的数据
     */
    @Override public List<Gank> loadFromDB() {
